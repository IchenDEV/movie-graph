      ...
      <div id="register">
        ...
        >
          ...
          <el-form-item prop="checkPass">
            <v-text-field  type="password" v-model="ruleForm2.checkPass" auto-complete="off" placeholder="确认密码"></v-text-field>
          </el-form-item>
          <el-form-item>
            <v-btn type="primary" @click="submitForm('ruleForm2')" style="width:100%;">注册</v-btn>
